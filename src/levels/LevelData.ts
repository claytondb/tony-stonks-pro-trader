...
export const LEVELS: LevelData[] = [
  ...
  // =========================================
  {
    ...
    // The cubicle farm, floor, walls and suspended ceiling are generated by
    // src/world/OfficeLevel.ts (buildOfficeInterior). Everything listed here
    // lives in the main skate aisle it leaves open: |x| < 5.2, full depth.
    objects: [
      // Long grinds down both edges of the main aisle
      { type: 'rail', position: [-4.2, 0, -12], rotation: [0, 90, 0], params: { length: 18 } },
      { type: 'rail', position: [4.2, 0, 12], rotation: [0, 90, 0], params: { length: 18 } },
      { type: 'rail', position: [4.2, 0, -12], rotation: [0, 90, 0], params: { length: 18 } },
      { type: 'rail', position: [-4.2, 0, 12], rotation: [0, 90, 0], params: { length: 18 } },

      // Ramps (using desks as impromptu ramps)
      { type: 'ramp', position: [-2.8, 0, -9], rotation: [0, 90, 0] },
      { type: 'ramp', position: [2.8, 0, 9], rotation: [0, -90, 0] },

      // Water cooler (obstacle)
      { type: 'water_cooler', position: [-4.4, 0, -7.5] },
      { type: 'water_cooler', position: [4.4, 0, 7.5] },
